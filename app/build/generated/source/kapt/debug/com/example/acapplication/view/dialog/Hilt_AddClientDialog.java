...
public abstract class Hilt_AddClientDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddClientDialog() {
    super();
  }

  Hilt_AddClientDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddClientDialog_GeneratedInjector) this.generatedComponent()).injectAddClientDialog(UnsafeCasts.<AddClientDialog>unsafeCast(this));
    }
  }
